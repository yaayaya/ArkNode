let en = {
  translation: {
    ...
    Thailand_1: {
      ...
      t3: "",
      t4: "",
      t5: "In the ancient legend, a giant man and a giant snake got into a fatal fight for a beautiful princess. In the end, both died, turning into the large and small Krabi peaks, and the two swords were lost forever. Rumour has it, in 1872, local villagers unearthed two ancient swords in Ban Na Luang area and presented them to government officials, but then nobody knew where the swords ended up. Meanwhile, the emblem of Krabi Province illustrates the two ancient crossed swords from the legend placed in front of the background of the Indian Ocean and Phanom Tea Mountain, the auspicious symbol of the development of the region. The preserved site is still on display in one of the stalactite caves in Khao Khanap Nam.",
      t6: "",
    },
    Thailand_2: {
      Title: "The Remains of Giants and Monsters - The Yi Village Site",
      t1: "In 2019, beneath the lawn next to Dormitory A of Taiwan Contemporary Culture Lab in Taipei, Taiwan, a construction team accidentally uncovered the remains of the ground beam, wall structures and parts of what seemed to be a giant skeleton while working on the underground pipeline.",
      t2: "In June, the international archaeological team stationed on-site unearthed the skeletons of a 5-metre-long giant and a 7-metre-long beast next to the ground beam and wall structures. The upper body of the giant beast resembles the deer, while the lower body the fish. Unknown mechanical devices are attached to the giant. The rare find captures the state of extreme tension of the battle that has taken both their lives. ",
      t3: "The Yicun Site of the Giant and the Beast measures 10 metres in length, 8 metres in width, and 2 metres in depth. ",
      t4: "Due to the urgent construction schedule, the rescue mission has the uncovered bones recorded in detail before being transferred to the National Tsing Hua University Archaeological Laboratory for further study. ",
      t5: "",
      t6: "",
    },
    Plant_1: {
    ...
    BuNam_2: {
      ...
      t4: "After six years of excavation and research, these unidentified metal objects scattered in the archaeological pits were transported back to Taiwan and assembled. They have attracted attention while on show at Central Park in Kaohsiung and will be exhibiting at the Taiwan Contemporary Culture Lab in Taipei in June 2022. ",

      t5: "In 2017, three mysterious giant metal plates with incomprehensible, distorted relief marks showed up at Goodwood Farm in the United Kingdom. Who made them, how and for what? What do the relief marks reveal? Does such distortion come from the buried underground tombs or severe stratigraphic fluctuations?",
      t6: "Some metal surfaces are in curved creases, some lava texture, and others rusted, mutilated, or damaged. Edges of the plates are sharply cut into monument-like forms.",
      t7: "Who did this, and with what tools? Experts are currently working on unravelling the mystery.",
      t8: "Later in the year, the three giant metal plates were exhibited at the Daylit Gallery of the Victoria and Albert Museum in the UK and received a good response.",
    },
    BuNam_3: {
      Title: "Bu Nam Civilisation at Rijksmuseum, Amsterdam, Netherlands",
      t1: "The exhibition is an intervention in which Bu Num objects engage in dialogue with the ancient cultures presented in the Asian Pavilion at Rijksmuseum. Four works representing the Bu Num civilisation appear at different locations in the galleries. Throughout the three years on display, the exquisite presentation and craftsmanship of the cultural relics received enthusiastic reviews.",
      t2: "The most striking and spectacular is a large sculpture titled Vessel of Fleeing Souls. The function of this virtually ‘excavated’ Bu Num vessel is unknown. Standing beside the French windows at the foot of the staircase, the UFO-like object seems to have flown in and landed itself in the gallery just moments ago, or perhaps ready to take off towards the waters outside. Halfway down the stairs, at the corner, stands an object labelled excavation number BM0803. It is a sculpture of a deity with one body and multiple heads. All faces appear mechanical, and all heads connect to one same structure, which hints at multiple identities.",
      t3: "Arriving in the gallery at B1, on the wall opposite the Longmen Cave Maitreya fragment and the Tianlongshan Bodhisattva torso is a bronze openwork plaque: Flowers Blooming Like a Piece of Brocade. It is likely an architectural element from the Bu Num civilisation – the plaque incorporates various flowers and butterflies. But a closer look reveals that all the flowers and butterflies are composed of industrial scraps.",
      t4: "Hidden in the showcases among the Chinese archaeological objects from the Han to the Six dynasties, ‘excavated’ object number BM7005 is a stone tablet depicting a mobile phone and an inscription. The illegible inscription adds to the combination of forms and patterns from different eras and cultures, creating an absurd sense of shifting time and place.",
      t5: "",
      t6: "",
    },
    BuNam_4: {
